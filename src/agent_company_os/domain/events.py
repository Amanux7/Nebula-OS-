...
class EventType(StrEnum):
    ...
    ORGANIZATION_GRAPH_VERSION_CREATED = "organization_graph_version_created"
    ORGANIZATION_GRAPH_ACTIVATED = "organization_graph_activated"
    AGENT_MESSAGE_CREATED = "agent_message_created"
    AGENT_MESSAGE_DELIVERED = "agent_message_delivered"
    AGENT_MESSAGE_REJECTED = "agent_message_rejected"
    AGENT_MESSAGE_CONSUMED = "agent_message_consumed"
